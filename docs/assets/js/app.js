...
var swiper$1 = createCommonjsModule(function (module) {
/**
 * Swiper 3.4.2
        ...
        s.history = {
            ...
            scrollToSlide: function(speed, value, runCallbacks) {
                ...
                if (value) {
                    for (var i = 0, length = s.slides.length; i < length; i++) {
                        var slide = s.slides.eq(i);
                        var slideHistory = this$1.slugify(slide.attr('data-history'));
        ...
        s.callPlugins = function (eventName) {
            ...
            for (var i = 0; i < s._plugins.length; i++) {
                if (eventName in s._plugins[i]) {
                    s._plugins[i][eventName](arguments$1[1], arguments$1[2], arguments$1[3], arguments$1[4], arguments$1[5]);
                }
            }
        };
        ...
        s.emit = function (eventName) {
            ...
            if (s.emitterEventListeners[eventName]) {
                for (i = 0; i < s.emitterEventListeners[eventName].length; i++) {
                    s.emitterEventListeners[eventName][i](arguments$1[1], arguments$1[2], arguments$1[3], arguments$1[4], arguments$1[5]);
                }
            }
            // Trigger plugins
    ...
    var Dom7 = (function () {
        ...
        Dom7.prototype = {
            ...
            each: function (callback) {
                ...
                for (var i = 0; i < this.length; i++) {
                    callback.call(this$1[i], i, this$1[i]);
                }
                return this;
            },
            html: function (html) {
                ...
                if (typeof selector === 'string') {
                    ...
                    if (el.matches) { return el.matches(selector); }
                        ...
                        for (i = 0; i < compareWith.length; i++) {
                            if (compareWith[i] === this$1[0]) { return true; }
                        }
                        return false;
                    }
                }
